...
export const metadata: Metadata = {
  ...
  keywords: ["contact", "get in touch", "support", "help", "message"],
  openGraph: {
    title: "Contact Us | Get in Touch",
    description: "Have questions? We'd love to hear from you. Send us a message and we'll respond as soon as possible.",
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">123 Main Street<br />San Francisco, CA 94103</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Follow Us</h2>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          <form className="space-y-6" action="/api/contact" method="POST">
            ...
            <div>
              <button
                type="submit"
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-blue-400"
              >
                Send Message
              </button>
            </div>
